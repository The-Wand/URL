...
//        
//        //Wand.Log.level = .verbose
//        let wand = 804244016 & .get { (repo: GitHubAPI.Repo) in
//            
//            print(repo)
//            e.fulfill()
//        } | 1 & .get { (post: TypicodeAPI.Post) in
//            
//            print(post)
//            e.fulfill()
//        }
...
//@inline(__always)
//public
//func |<U: Ask.T, T: Ask.T>(l: Ask<U>, r: Ask<T>) -> Core {
//    T.ask(with: U.ask(with: nil as Core, ask: l),
//          ask: r)
//}

//func &<C, T> (scope: C, ask: Ask<T>) -> Ask<T> {
//    
//}
